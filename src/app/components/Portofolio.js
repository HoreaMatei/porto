          ...
          <div className={styles.description}>
            ...
            <RevealOnScroll>
              <p className={styles.description_p}>
                ...
                this app allows users to generate and explore AI-created images
                seamlessly, with secure authentication for personalized access
              </p>
            </RevealOnScroll>
          ...
          <div className={styles.description}>
            ...
            <RevealOnScroll>
              <p className={styles.description_p}>
                ...
                database, <span className={styles.span}>TailwindCSS </span> for
                styling and the
